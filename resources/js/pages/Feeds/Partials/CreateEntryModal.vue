...
import { store as storeEntry } from '@/actions/App/Http/Controllers/EntryController';
...
const submit = () => {
    form.post(storeEntry(props.feed).url, {
        onSuccess: () => {
            form.reset();
            emit('close');
        },
            ...
            <div class="grid gap-4 py-4">
                ...
                <div class="grid gap-2">
                    ...
                    <Input
                        ...
                        required
                    />
                    <div v-if="form.errors.published_at" class="text-sm text-red-500">
