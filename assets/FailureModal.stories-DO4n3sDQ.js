import{n as e}from"./chunk-DnJy8xQt.js";import{N as t,t as n}from"./vue.esm-bundler-BO0T5OF3.js";import{m as r,n as i,p as a,t as o}from"./modal-DlA2V8wY.js";import{n as s,t as c}from"./FailureModal-CFxtXctQ.js";import{n as l,t as u}from"./entries-CB4_sjeI.js";import{n as d,t as f}from"./feeds-kHOB93VY.js";var p,m,h,g;e((()=>{r(),n(),o(),l(),d(),s(),p={title:`Modals/FailureModal`,component:c,render:e=>({components:{ModalsPortal:i},setup(){return t(()=>{a(c,e)}),{}},template:`<ModalsPortal />`})},m={args:{title:`Processing failed`,description:u[0].name,details:`Something went wrong during transcription.`}},h={args:{title:`Synchronization failed`,description:f[0].title,details:`ErrorException: Trying to access array offset on value of type null in /var/www/html/app/Jobs/SyncFeedJob.php:87
Stack trace:
...
#36 {main}`}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...h.parameters?.docs?.source}}},g=[`ProcessingFailed`,`SynchronizationFailed`]}))();export{m as ProcessingFailed,h as SynchronizationFailed,g as __namedExportsOrder,p as default};